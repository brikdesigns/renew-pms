 ...
 *
 * - Staff / practice_admin: looks up via practice_members
 * - platform_admin: if no membership, falls back to the first practice
...
export async function getPracticeId(
  ...
  if (authUser.profile.system_role === 'platform_admin') {
